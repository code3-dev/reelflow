...
export function encodeGraphqlRequestData(shortcode: string): string {
  const requestData = {
    av: '0',
    __d: 'www',
    __user: '0',
...
export function formatPageJson(postHtml: CheerioAPI): VideoInfo | null {
...
export function validateInstagramURL(postUrl: string): string {
  if (!postUrl) {
